...
export const defaultPageContent: SitePageContent = {
  ...
  footer: {
    brandLogoImage: "/footer-brand-demo.jpg",
    brandTitle: { en: "Attacker 2026", vi: "Attacker 2026" },
    brandSubtitle: {
      en: "student fintech challenge",
      vi: "student fintech challenge",
    },
    description: {
    ...
    rounds: [
      ...
      },
      {
        ...
        round3EmergingRules: {
          ...
          vi: "20 đội thi Bảng Ươm mầm chỉnh sửa báo cáo mô tả dự án và nộp lại trước hạn chính thức của Bảng Ươm mầm. Ban tổ chức đánh giá các báo cáo đã cập nhật theo lịch trình công bố, sau đó công bố 10 đội đạt giải Ươm mầm.",
        },
        round3FinalRules: {
